<?php /* Smarty version 2.6.26, created on 2016-01-19 20:12:31
...
/元</td></tr>
	...
	<table id="cart" cellspacing="1">
		...
		<tr><td width="25%">收货人信息：</td><td width="25%">李炎恢</td><td width="25%">电子邮件：</td><td width="25%">bnbbs@163.com</td></tr>
		<tr><td>收货人地址：</td><td>江苏盐城大庆中路</td><td>邮政编码：</td><td>224000</td></tr>
		<tr><td>手机信息：</td><td>13748930203</td><td>标志性建筑：</td><td>移动总部斜对面</td></tr>
	</table>

	<p><a href="?a=member">修改收货人信息</a></p>

	<table id="cart" cellspacing="1">
		<caption>物流配送信息</caption>
		<tr><th width="10%"></th><th width="20%">名称</th><th width="50%">描述</th><th>运费</th></tr>
		<tr><td><input type="radio" name="delivery_radio" value="10" title="申通快递" onclick="changeDelivery(this);" checked="checked" /></td><td>申通快递</td><td>江浙沪6元起步，省外11元起步，1公斤内，额外的1公斤加10元。</td><td>10元</td></tr>
		<tr><td><input type="radio" name="delivery_radio" value="20" title="邮政EMS" onclick="changeDelivery(this);"  /></td><td>邮政EMS</td><td>江浙沪12元起步，省外20元起步，1公斤内，额外的1公斤加10元。</td><td>20元</td></tr>
		<tr><td><input type="radio" name="delivery_radio" value="6" title="邮政平邮" onclick="changeDelivery(this);"  /></td><td>邮政平邮</td><td>无</td><td>6元</td></tr>
	</table>

	<p>您要支付的运费为：<strong id="delivery"></strong>/元</p>
