<?php /* Smarty version 2.6.26, created on 2016-01-13 20:29:28
...
<form method="post" name="add" action="?a=attr&m=add">
	...
	<dl class="form">
		<dd>属性名称：<input type="text" name="name" class="text" id="name" onblur="checkName();"/> <span class="red">[必填]</span> ( * 2-4位之间 )</dd>
